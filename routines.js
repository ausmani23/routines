...
},
{
  ...
  blocks:[
    ...
    {name:"Calf raises", badge:"req", mode:"reps", target:"15 reps", sets:3, est:75,
     dose:"3 × 15, 90° gate with the wedge, set 3 at RPE 9",
     cue:"Carolyn's daily prescription. 90° at the ankle only — no dorsiflexion past neutral, wedge in. Alternate straight-knee and bent-knee sets.",
     levels:["Bodyweight, 3 sec up / 3 sec down, full contraction at the top. The reliable floor.",
             "Loaded to ~40 lb, 3 × 15, slow tempo, set 3 landing at RPE 9. The RPE is the target; the weight is whatever reaches it.",
             "Heavier and lower-rep — working toward 4 × 6 near-max, ~3 sec a rep. ASK CAROLYN FIRST: this is where the tendon literature points, not what she has prescribed."]},
    ...
    {variant:1, name:"Wall-sit isometric", badge:"new", mode:"time", sec:45, sets:2,
     dose:"2 × 45 sec, ~70% effort",
     cue:"For the upper-outer right knee. This one hold covers the plausible candidates — quad tendon, kneecap-facet overload — without needing to know which it is. Stop at the angle where it complains; shallower is fine.",
     levels:["Back on a wall, thighs around 60° — shallower if the knee grumbles. Both feet.",
             "Band looped behind the knees, Spanish-squat style, torso upright.",
             "Single-leg wall sit, or a split-squat hold with the back foot elevated."]},
...
},
{
  ...
  sub:"Once a day, alternating. A is the back reset; B is hips, groin and the posterior chain that actually keeps the back quiet.",
  variants:["Day A — back","Day B — hips & chain"],
  variantTags:["reset & lengthen","strength that travels"],
  variantMode:"alternate", defaultLevel:0,
  blocks:[
    ...
    {group:"Day A — mobilise & lengthen", variant:0, name:"Standing extension",
    ...
    {variant:0, name:"Supine twist", mode:"time", sec:60, sides:2, dose:"60 sec per side",
     detail:"On your back, arms in a T. Draw one knee across the body, turn your head the opposite way. Switch.",
     cue:"Let gravity do it. Don't press the knee down with your hand."},

    {variant:0, name:"Side-reach child's pose", mode:"time", sec:45, sides:2, dose:"45 sec per side",
     detail:"Hips to heels, walk both hands out to one side until you feel a long pull down the opposite flank, ribs to hip. Switch.",
     cue:"Breathe into the stretched side — feel those ribs expand under tension."},

    {variant:0, name:"Standing side bend", mode:"time", sec:30, sides:2, dose:"30 sec per side",
     detail:"Stand tall, one arm overhead, lean away. Push the hip out on the reaching side to lengthen the QL, not just the lat.",
     cue:"The hip shift is the whole exercise. Without it you're only stretching lat."},

    {variant:0, name:"Half-kneeling hip flexor lunge", mode:"time", sec:45, sides:2, dose:"45 sec per side",
    ...
    {variant:0, name:"Figure-4 glute stretch", mode:"time", sec:45, sides:2, dose:"45 sec per side",
     detail:"On your back, ankle over opposite knee, pull the far thigh toward you.",
     cue:"Tight glutes refer straight up into the low back. This is often where the tightness actually lives."},
    ...
    {group:"Day B — open the hips", variant:1, name:"90/90 seated rotation",
    ...
    {variant:1, name:"Adductor rock-back", badge:"new", mode:"time", sec:45, sides:2, dose:"45 sec per side",
...
{
  id:"ql", name:"QL flare — right side", accent:"#7FA8C9",
  sub:"Conditional, not daily. For when the right QL is cranky. Slow nasal breathing throughout — the QL grips, it doesn't tear.",
  blocks:[
