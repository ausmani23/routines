...
},
{
  ...
  blocks:[
    ...
    {name:"Calf raises", badge:"req", mode:"reps", target:"15 reps", sets:3, est:100, defaultLevel:1,
     dose:"3 × 15, 90° gate with the wedge, set 3 at RPE 9",
     cue:"90° at the ankle only — no dorsiflexion past neutral, wedge in. Alternate straight-knee and bent-knee sets. 3 × 15 is the right dose; the levels change how HARD 15 reps are, never how many. If the 15th rep isn't a grind, go up a level — don't add reps.",
     levels:["Both legs, bodyweight. 3 sec up, 3 sec down, full contraction at the top. The floor — drop here on a bad morning.",
             "Single leg, bodyweight, 15 per side. Standing on one leg roughly doubles the load: this is how you make 15 reps hard with no equipment at all.",
             "Single leg with the ~40 lb load, 15 per side, set 3 landing at RPE 9. The RPE is the target; the weight is whatever reaches it.",
             "Single leg, heavier, 8–10 per side. Only once 15 with the full load is comfortably RPE 9 — and tell Carolyn before you make this move."]},
