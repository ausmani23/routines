...
const ROUTINES = [
{
  ...
  blocks:[
    {group:"Round one", name:"Cat–cow", badge:"req", mode:"time", sec:45, dose:"45 sec · slow, breath-led",
    ...
    {name:"Dynamic supine twist", mode:"time", sec:45, dose:"45 sec · alternating sides",
    ...
    {group:"Round two", name:"Cat–cow", tag:"2nd round", badge:"req", mode:"time", sec:45, dose:"45 sec · slow, breath-led",
     cue:"Same as before, a little deeper now that the spine has warmed to the idea."},
    {name:"Dynamic supine twist", tag:"2nd round", mode:"time", sec:45, dose:"45 sec · alternating sides",
...
},
{
  ...
  sub:"Daily, alternating A / B. The tendon non-negotiables run on both days; the second half rotates. Bursitis (Aug 2026): now on Carolyn's 11-week return plan (started Aug 17) — the left heel stays out of loaded end-range dorsiflexion, and mini-pogos and the knee-to-wall test stay PAUSED until her week 5 (~mid-Sep) at the earliest.",
